  ...
  return <div id="home" className="py-32 lg:py-60 md:py-48 relative z-0 overflow-x-clip">
    ...
    <div className="container">
      <div className="flex flex-col items-center" >
        ...
        <Image src={memojiImage} className="size-[100px]" alt="Peeking from behind the laptop" />
        <div className=" bg-gray-950 border rounded-lg border-gray-800 py-1.5 inline-flex items-center gap-4 px-4">
      ...
      <div className="max-w-lg mx-auto">
        <h1 className="font-serif text-3xl md:text-5xl text-center tracking-wide mt-8">Building Exceptional User Experiences</h1>
      ...
      <span className="font-semibold cursor-pointer ">
        ...
        {/* <button className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl  ">
          ...
          <a
            href="https://wa.me/2349050454468?text=Hello%20Daniel,%20I%20am%20interested%20in%20working%20with%20you"
            target="_blank"
        ...
        <button
          onClick={() =>
            window.open(
              "https://wa.me/2349050454468?text=Hello%20Daniel,%20I%20am%20interested%20in%20working%20with%20you",
              "_blank"
            )
          }
